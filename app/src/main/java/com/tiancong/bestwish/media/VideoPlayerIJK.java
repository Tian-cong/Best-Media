...
public class VideoPlayerIJK extends FrameLayout {
    ...
    private void createSurfaceView() {
        ...
        Log.d("sssss", "sdasdasdasfdasfasfasfsa: ");
    }
    ...
    private class LmnSurfaceCallback implements SurfaceHolder.Callback {
        ...
        public void surfaceCreated(SurfaceHolder holder) {
            Log.d("sssss", "surfaceCreated: ");
        }

        @Override
        public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
            //surfaceview创建成功后，加载视频
            Log.d("sssss", "surfaceChanged: ");
            //load();
        }

        @Override
        public void surfaceDestroyed(SurfaceHolder holder) {
            Log.d("ssssss", "surfaceDestroyed: ");
        }
    }
     ...
     * 加载视频
     */
    public void load(SurfaceHolder holder) {
